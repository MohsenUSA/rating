...
const Emojis = ({ selected, onSelect }) => {
  return (
    ...
    >
      <IconButton
        icon={<FaSadTear style={{ fontSize: '2.5rem', color: 'red' }} />}
        aria-label="sad"
        onClick={() => onSelect(1)}
        colorScheme="gray"
        size="xlg"
      ...
      />
      <IconButton
        icon={<FaFrown style={{ fontSize: '2.5rem', color: 'orange' }} />}
        aria-label="unhappy"
        onClick={() => onSelect(2)}
        colorScheme="gray"
        size="xlg"
      ...
      />
      <IconButton
        icon={<FaMeh style={{ fontSize: '2.5rem', color: 'yellow' }} />}
        aria-label="neutral"
        onClick={() => onSelect(3)}
        colorScheme="gray"
        size="xlg"
      ...
      />
      <IconButton
        icon={<FaSmile style={{ fontSize: '2.5rem', color: 'lightgreen' }} />}
        aria-label="happy"
        onClick={() => onSelect(4)}
        colorScheme="gray"
        size="xlg"
      ...
      />
      <IconButton
        icon={<FaGrinStars style={{ fontSize: '2.5rem', color: 'green' }} />}
